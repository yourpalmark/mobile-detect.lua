...
-- iPad, NexusTablet, GoogleTablet, SamsungTablet, Kindle, SurfaceTablet, HPTablet,
-- AsusTablet, BlackBerryTablet, HTCtablet, MotorolaTablet, NookTablet, AcerTablet,
...
-- PlaystationTablet, TrekstorTablet, PyleAudioTablet, AdvanTablet, DanyTechTablet,
-- GalapadTablet, MicromaxTablet, KarbonnTablet, AllFineTablet, PROSCANTablet,
-- YONESTablet, ChangJiaTablet, GUTablet, PointOfViewTablet, OvermaxTablet,
-- HCLTablet, DPSTablet, VistureTablet, CrestaTablet, MediatekTablet,
-- ConcordeTablet, GoCleverTablet, ModecomTablet, VoninoTablet, ECSTablet,
-- StorexTablet, VodafoneTablet, EssentielBTablet, RossMoorTablet, iMobileTablet,
-- TolinoTablet, AudioSonicTablet, AMPETablet, SkkTablet, TecnoTablet, JXDTablet,
-- iJoyTablet, FX2Tablet, XoroTablet, ViewsonicTablet, VerizonTablet, OdysTablet,
-- CaptivaTablet, IconbitTablet, TeclastTablet, OndaTablet, JaytechTablet,
-- BlaupunktTablet, DigmaTablet, EvolioTablet, LavaTablet, AocTablet, MpmanTablet,
-- CelkonTablet, WolderTablet, MediacomTablet, MiTablet, NibiruTablet, NexoTablet,
-- LeaderTablet, UbislateTablet, PocketBookTablet, KocasoTablet, HisenseTablet,
-- Hudl, TelstraTablet, GenericTablet
-- If the device is not detected by the regular expressions from Mobile-Detect, a test is made against
