...
-- iJoyTablet, FX2Tablet, XoroTablet, ViewsonicTablet, OdysTablet, CaptivaTablet,
...
-- PocketBookTablet, KocasoTablet, Hudl, TelstraTablet, GenericTablet
-- If the device is not detected by the regular expressions from Mobile-Detect, a test is made against
...
-- Vivaldi, Chrome, Dolfin, Opera, Skyfire, Edge, IE, Firefox, Bolt, TeaShark,
