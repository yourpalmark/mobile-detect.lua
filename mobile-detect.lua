...
-- CelkonTablet, WolderTablet, MiTablet, NibiruTablet, NexoTablet, LeaderTablet,
-- UbislateTablet, PocketBookTablet, KocasoTablet, HisenseTablet, Hudl,
-- TelstraTablet, GenericTablet
-- If the device is not detected by the regular expressions from Mobile-Detect, a test is made against
