...
=== TEST 1: mobile_detect.is("AndroidOS") - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.is("AndroidOS", user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.is("iOS") - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.is("iOS", user_agent))
    }
}
--- request
GET /t
...
=== TEST 3: mobile_detect.is("BlackBerry") - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.is("BlackBerry", user_agent))
    }
}
--- request
GET /t
...
=== TEST 4: mobile_detect.is("iOS") - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.is("Bot") - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
