...
=== TEST 1: mobile_detect.mobile() - Android
--- http_config
init_by_lua_block {
...
=== TEST 2: mobile_detect.mobile() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.mobile() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.mobile() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.mobile() - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
