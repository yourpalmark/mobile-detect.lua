...
=== TEST 1: mobile_detect.phone() - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.phone(user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.phone() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.phone() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.phone() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.phone() - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
