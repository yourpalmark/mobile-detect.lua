...
=== TEST 1: mobile_detect.version_str("Android") - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version_str("Android", user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.version_str("iPhone") - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version_str("iPhone", user_agent))
    }
}
--- request
GET /t
...
=== TEST 3: mobile_detect.version_str("Webkit") - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version_str("Webkit", user_agent))
    }
}
--- request
GET /t
...
=== TEST 4: mobile_detect.version_str("Chrome") - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version_str("Chrome", user_agent))
    }
}
--- request
GET /t
...
=== TEST 5: mobile_detect.version_str("Version") - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version_str("Version", user_agent))
    }
}
--- request
GET /t
