...
=== TEST 1: mobile_detect.os() - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.os(user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.os() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.os() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.os() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
