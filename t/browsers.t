...
=== TEST 1: mobile_detect.browsers() - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.browsers(user_agent)[1])
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.browsers() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.browsers() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.browsers() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.browsers() - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
