...
=== TEST 1: mobile_detect.match("Android") - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.match("Android", user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.match("iOS") - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.match("iOS", user_agent))
    }
}
--- request
GET /t
...
=== TEST 3: mobile_detect.match("BB10") - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.match("BB10", user_agent))
    }
}
--- request
GET /t
...
=== TEST 4: mobile_detect.match("Macintosh") - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.match("Macintosh", user_agent))
    }
}
--- request
GET /t
...
=== TEST 5: mobile_detect.match("Google.[2|3]") - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.match("Google.+[2|3]", user_agent))
    }
}
--- request
GET /t
