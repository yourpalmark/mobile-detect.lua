...
=== TEST 1: mobile_detect.mobile_grade() - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.mobile_grade(user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.mobile_grade() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.mobile_grade() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.mobile_grade() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.mobile_grade() - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
