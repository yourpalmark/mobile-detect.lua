...
=== TEST 1: mobile_detect.version("Android") - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version("Android", user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.version("iPhone") - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version("iPhone", user_agent))
    }
}
--- request
GET /t
...
=== TEST 3: mobile_detect.version("Webkit") - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version("Webkit", user_agent))
    }
}
--- request
GET /t
...
=== TEST 4: mobile_detect.version("Chrome") - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version("Chrome", user_agent))
    }
}
--- request
GET /t
...
=== TEST 5: mobile_detect.version("Version") - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.version("Version", user_agent))
    }
}
--- request
GET /t
