...
=== TEST 1: mobile_detect.browser() - Android
--- http_config
init_by_lua_block {
...
location = /t {
    content_by_lua_block {
        ...
        ngx.say(mobile_detect.browser(user_agent))
    }
}
--- request
GET /t
...
=== TEST 2: mobile_detect.browser() - iPhone6
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 3: mobile_detect.browser() - BlackBerry
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 4: mobile_detect.browser() - MacBook
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
...
=== TEST 5: mobile_detect.browser() - Bot
--- http_config
init_by_lua_block {
    mobile_detect = require "mobile-detect"
}
